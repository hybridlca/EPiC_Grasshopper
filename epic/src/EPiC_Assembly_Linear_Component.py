...
Creates a linear assembly based on the selected geometry and EPiC Materials
    ...
    Inputs:
        ...
        **Selected_Lines_(m): A selection of lines that represent the EPiC Assembly.
        A length calculation will be performed on objects to calculate embodied environmental flows.
        (**REQUIRED)
...
geometry_warning = "Brep/surface/point input detected, please input linear geometry"
