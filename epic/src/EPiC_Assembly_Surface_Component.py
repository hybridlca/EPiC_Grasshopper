...
Creates a surface assembly based on the selected geometry and EPiC Materials
    ...
    Inputs:
        ...
        **Selected_Surfaces_and/or_Numerical_Values_(m²): A selection of surfaces that represent the EPiC Assembly AND/OR values in m².
        An area calculation will be performed on geometry to calculate embodied environmental flows.
        (**REQUIRED)
...
geometry_warning = "Brep/line/point input detected. Please input a surface, closed polyline, or numerical value"
