...
Creates a volumetric assembly based on the selected geometry and EPiC Materials
    ...
    Inputs:
        ...
        **Selected_Volumes_(m³): A selection of volumes that represent the EPiC Assembly.
        A volume calculation will be performed on objects to calculate embodied environmental flows.
        (**REQUIRED)
